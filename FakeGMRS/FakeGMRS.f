...
C     SAMPLE PARAMETERS SIMILAR TO THE BOUND EXAMPLE KEITA ONCE GAVE ME      
      ...
      DOUBLE PRECISION, PARAMETER :: LX = 500
      DOUBLE PRECISION, PARAMETER :: LY = 500
      DOUBLE PRECISION, PARAMETER :: LZ = 500
      ...
      INTEGER, PARAMETER          :: NX = 51!75
      INTEGER, PARAMETER          :: NY = 51!40
      INTEGER, PARAMETER          :: NZ = 51!72
