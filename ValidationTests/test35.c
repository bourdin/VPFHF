/*
 test35.c: Coupled fracture propagation and fracture fluid flow.
 (c) 2010-2012 Chukwudi Chukwudozie cchukw1@tigers.lsu.edu
 
 ./test35 -n 201,2,201 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.05 -epsilon 0.04 -pc0_theta 0 -pc0_phi 150 -orientation 1 -nw 1
 ./test35 -n 101,2,101 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.08 -epsilon 0.08 -pc0_theta 0 -pc0_phi 150 -orientation 1 -nw 1
 ./test35 -n 51,2,51 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.16 -epsilon 0.16 -pc0_theta 0 -pc0_phi 150 -orientation 1 -nw 1
 
 
 ./test35 -n 21,2,21 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.4 -epsilon 0.4 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1
 
 ./test35 -n 51,2,51 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.16 -epsilon 0.16 -pc0_theta 0 -pc0_phi 150 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -fracsnes_snes_type qn -fracsnes_snes_max_linear_solve_fail
 
 
 
 ./test35 -n 101,2,101 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.1 -epsilon 0.1 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -fracsnes_snes_type tr -fracsnes_snes_max_linear_solve_fail -fracsnes_pc_type lu -fracsnes_ksp_type preonly
 
 
 ./test35 -n 51,2,51 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.25 -epsilon 0.16 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -Fracsnes_snes_type tr -Fracsnes_snes_view  -Fracsnes_snes_monitor -Fracsnes_snes_max_it 100
 
 ./test35 -n 101,2,101 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.1 -epsilon 0.1 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -fracsnes_snes_type tr
 
 
 ./test35 -n 101,2,101 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.1 -epsilon 0.1 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -Fracsnes_snes_type tr -Fracsnes_snes_view  -Fracsnes_snes_monitor -Fracsnes_snes_max_it 100
 
 ./test35 -n 201,2,201 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.08 -epsilon 0.05 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_type qn
 
 ./test35 -n 101,2,101 -l 4,0.04,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.1 -epsilon 0.1 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -fracsnes_snes_type tr
 
 ./test35 -n 151,2,151 -l 4,0.01,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.005,2 -pc0_thickness 0.1 -epsilon 0.1 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -fracsnes_snes_type tr
 
  ./test35 -n 101,2,101 -l 4,0.04,4 -npc 1 -pc0_r 0.2 -pc0_center 2.,0.02,2 -pc0_thickness 0.08 -epsilon 0.04 -pc0_theta 0 -pc0_phi 90 -orientation 1 -nw 1 -Fracsnes_snes_max_linear_solve_fail  -fracsnes_snes_type tr -Qw 0.0
