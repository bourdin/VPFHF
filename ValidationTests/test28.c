/*
 ...
 ./test28 -n 51,11,2 -l 1,1,0.01 -m_inv 10 -maxtimestep 20 -flowsolver FLOWSOLVER_snesMIXEDFEM -P_X0_BC FIXED -P_X1_BC FIXED -Q_Y0_BC_1 FIXED -Q_Y1_BC_1 FIXED -Q_Z0_BC_2 FIXED -Q_Z1_BC_2 FIXED -theta 1 -deltat 1 -maxtimestep 20

 ./test28 -n 51,11,2 -l 1,1,0.01 -m_inv 10 -maxtimestep 20 -flowsolver FLOWSOLVER_snesstandarDFEM -P_X0_BC FIXED -P_X1_BC FIXED -Q_Y0_BC_1 FIXED -Q_Y1_BC_1 FIXED -Q_Z0_BC_2 FIXED -Q_Z1_BC_2 FIXED -theta 1 -deltat 1 -maxtimestep 20 -k 1,1,1 -g 0,0,0 -rhof 0. -mu 1 -theta 1.
 
 ./test28 -n 51,51,2 -l 1,1,0.01 -m_inv 10 -ts_dt 1 -ts_max_steps 20 -flowsolver FLOWSOLVER_tsMIXEDFEM -P_X0_BC FIXED -P_X1_BC FIXED -Q_Y0_BC_1 FIXED -Q_Y1_BC_1 FIXED -Q_Z0_BC_2 FIXED -Q_Z1_BC_2 FIXED -theta 1 -deltat 1 -maxtimestep 20
 */
