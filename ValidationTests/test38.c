...
./test38  -n 101,2,101 -l 4,0.04,4 -maxtimestep 1 timestepsize 1 -theta 1 -nw 1 -w0_coords 2,0.02,2 -w0_Qw 1 -w0_constraint Rate -w0_rw 0.1 -w0_type injector -m_inv 0 -flowsolver FLOWSOLVER_snesstandardFEM
 
 ./test38  -n 101,2,101 -l 4,0.04,4 -maxtimestep 1 timestepsize 1 -theta 1 -nw 1 -w0_coords 2,0.02,2 -w0_Qw 1 -w0_constraint Rate -w0_rw 0.1 -w0_type injector -m_inv 0 -flowsolver FLOWSOLVER_snesstandardFEM -npc 1 -pc0_r 0.2 -pc0_center 2.,0.02,2 -pc0_thickness 0.08 -epsilon 0.04 -pc0_theta 0 -pc0_phi 90 
 
 
 ./test38  -n 101,2,101 -l 4,0.04,4 -maxtimestep 1 timestepsize 1 -theta 1 -nw 1 -w0_coords 2,0.02,2 -w0_Qw 1 -w0_constraint Rate -w0_rw 0.01 -w0_type injector -m_inv 0 -flowsolver FLOWSOLVER_snesstandardFEM -npc 1 -pc0_r 0.2 -pc0_center 2.,0.02,2 -pc0_thickness 0.16 -epsilon 0.16 -pc0_theta 0 -pc0_phi 90 
 
 ./test38  -n 101,2,101 -l 4,0.04,4 -maxtimestep 1 timestepsize 1 -theta 1 -nw 1 -nfw 1 -fracw0_coords 2,0.02,2 -fracw0_Qw 1 -fracw0_constraint Rate -fracw0_rw 0.01 -fracw0_type injector -m_inv 0 -flowsolver FLOWSOLVER_snesstandardFEM -npc 1 -pc0_r 0.2 -pc0_center 2.,0.02,2 -pc0_thickness 0.16 -epsilon 0.16 -pc0_theta 0 -pc0_phi 90 
 
 
 
 
 ./test38  -n 101,2,101 -l 4,0.04,4 -maxtimestep 1 timestepsize 1 -theta 1 -nfw 1 -fracw0_coords 2,0.02,2 -fracw0_Qw 1 -fracw0_constraint Rate -fracw0_rw 0.01 -fracw0_type injector -m_inv 0 -flowsolver FLOWSOLVER_snesstandardFEM -npc 1 -pc0_r 0.2 -pc0_center 2.,0.02,2 -pc0_thickness 0.16 -epsilon 0.16 -pc0_theta 0 -pc0_phi 90 -nw 1 -fracw0_coords 2,0.02,1.5 -fracw0_Qw 1 -fracw0_constraint Rate -fracw0_rw 0.01 -fracw0_type injector
 
 
 
 
 ./test38  -n 101,2,101 -l 4,0.04,4 -maxtimestep 1 timestepsize 1 -theta 1 -nw 1 -w0_coords 2,0.02,1 -w0_constraint Rate -w0_rw 0.01 -w0_type injector -m_inv 0 -flowsolver FLOWSOLVER_snesstandardFEM -npc 1 -pc0_r 0.2 -pc0_center 2.,0.02,2 -pc0_thickness 0.16 -epsilon 0.16 -pc0_theta 0 -pc0_phi 90 -nfw 1 -fracw0_coords 2,0.02,2  -fracw0_constraint Rate -fracw0_rw 0.01 -fracw0_type injector -w0_Qw 1e-5 -fracw0_Qw 1
 
 
 raint Rate -w0_rw 0.01 -w0_type injector -m_inv 0 -flowsolver FLOWSOLVER_snesstandardFEM -npc 1 -pc0_r 0.2 -pc0_center 2.,0.02,2 -pc0_thickness 0.16 -epsilon 0.16 -pc0_theta 0 -pc0_phi 90 -nfw 1 -fracw0_coords 2,0.02,2  -fracw0_constraint Rate -fracw0_rw 0.01 -fracw0_type injector -w0_Qw 0 -fracw0_Qw 0
...
int main(int argc,char **argv)
{
  ...
  for (k = zs1; k < zs1+zm1; k++) {
    for (j = ys1; j < ys1+ym1; j++) {
      for (i = xs1; i < xs1+xm1; i++) {
        perm_array[k][j][i][0] = 1e-5;
        perm_array[k][j][i][1] = 1e-5;
        perm_array[k][j][i][2] = 1e-5;
  ...
  ierr = VecSet(fields.pressure,0.1);CHKERRQ(ierr);
  ...
  ierr = PetscPrintf(PETSC_COMM_WORLD,"Initiial crack volume =  %e\n",ctx.CrackVolume);CHKERRQ(ierr);
