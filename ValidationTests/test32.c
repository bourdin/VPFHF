/*
 test32.c: 3D Flow problem with source term [pressure = sin(2*pi*x)*sin(2*pi*y)*sin(2(pi*z)]. All pressure boundary condition (Implementation of test31.c with dirichtlet boundary condition)
