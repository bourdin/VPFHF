/*
 test32.c: 1D Mandel's problem. Coupling of flow and displacmement solver for geomechanics application.
...
./test32 -l 5,0.01,1 -n 21,2,11 -flowsolver FLOWSOLVER_snesstandarDFEM -E 1. -nu 0.2 -maxtimestep 5 -timestepsize 0.02 -resflowmechcoupling fixedstress
 */
