/*
 test31.c: 2D from Zheng et al. Coupling of flow and displacmement solver for geomechanics application.
...
Reservoir simultion with the finite element method using Biot poroelastic approach
 ...
 ./test31 -l 200,1,20 -n 11,2,11 -flowsolver FLOWSOLVER_snesMIXEDFEM -E 14400 -nu 0.2 -maxtimestep 20 -timestepsize 2
 */
