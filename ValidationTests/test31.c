/*
 test31.c: 3D SNES. Flow problem with source term [pressure = 1/(3*pi^2)*cos(pi*x)*cos(pi*y)*cos(pi*z)]. All pressure boundary condition
 (c) 2010-2012 Chukwudi Chukwudozie cchukw1@tigers.lsu.edu
 
 ./test31 -n 11,11,11 -l 1,1,1 -m_inv 0 -theta 1 -velp_pc_type jacobi -maxtimestep 1
