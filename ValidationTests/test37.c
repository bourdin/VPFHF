/*
 *  test37.c: 2D/3D. Coupled reservoir and fracture flow example.
 *   (c) 2012-2014 Chukwudi Chukwudozie cchukw1@tigers.lsu.edu
 *
 *    ./test37 -options_file test37.opts
 *     ./test37 -options_file test37_1.opts  -U_snes_monitor   -u_ksp_monitor -alpha 0 -beta 0 -insitumin 0,0,0,0,0,0 -insitumax 0,0,0,0,0,0 -eta 1.e-3 -unilateral nocompression
 *
 *      
 */
...
int main(int argc,char **argv)
{
  ...
  PetscReal       p = 1e-6;
  PetscInt        altminit = 0,altminitv = 0;
