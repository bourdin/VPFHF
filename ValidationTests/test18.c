/*
 test18.c: Solves for the displacement and v-field in a pressurized penny shaped crack in 3d (Sneddon 3D)
...
int main(int argc,char **argv)
{
	...
	switch (orientation) {
		...
		case 5:
			...
			break;
		default:
			SETERRQ1(PETSC_COMM_WORLD,PETSC_ERR_USER,"ERROR: Orientation should be one of {1,2,3,4,5}, got %i\n",orientation);
			break;
	}  	
